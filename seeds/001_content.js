        ...
        [
          {
            ...
            link: null,
            media_link: `${process.env.SERVER_URL}/public/images/content/bare_dating.png`,
          ...
          },
          {
            ...
            link: null,
            media_link: `${process.env.SERVER_URL}/public/images/content/oman_fm.png`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            link: null,
            media_link: `${process.env.SERVER_URL}/public/images/content/movie_predictor.jpg`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            link: null,
            media_link: `${process.env.SERVER_URL}/public/images/content/diagram_optimiser.png`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            link: null,
            media_link: `${process.env.SERVER_URL}/public/images/content/web_library.jpg`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            link: null,
            media_link: `${process.env.SERVER_URL}/public/images/content/terraform_visualiser.jpg`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            link: null,
            media_link: `${process.env.SERVER_URL}/public/images/content/shared_whiteboard.jpg`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          ...
          },
          {
            ...
            text: null,
            link: null,
            media_link: `${process.env.SERVER_URL}/public/documents/Decision_Trees.pdf`,
...

          {
            ...
            text: null,
            link: null,
            media_link: `${process.env.SERVER_URL}/public/documents/2PD_Article.html`,
          ...
          },
          {
            ...
            text: null,
            link: null,
            media_link: `${process.env.SERVER_URL}/public/documents/BARE_Dating_Article.html`,
            media_type: types.WEB_PAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            text: null,
            link: null,
            media_link: `${process.env.SERVER_URL}/public/documents/Foreign_Ministry_of_Oman_Google_Play.html`,
            media_type: types.WEB_PAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
