      ...
      return knex('profile').insert([
        {
          ...
          profile_picture_link: `${process.env.IP_DOMAIN}/public/images/site/profile_picture.jpg`,
          profile_background_link: `${process.env.IP_DOMAIN}/public/images/site/profile_background.jpg`,
          projects_background_link: `${process.env.IP_DOMAIN}/public/images/site/projects_background.jpg`,
          articles_background_link: `${process.env.IP_DOMAIN}/public/images/site/articles_background.jpg`,
          hobbies_background_link: `${process.env.IP_DOMAIN}/public/images/site/hobbies_background.jpg`,
