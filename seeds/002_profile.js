      ...
      return knex('profile').insert([
        {
          ...
          profile_picture_link: `${process.env.SERVER_PROTOCOL}://${process.env.IP_DOMAIN}:${process.env.SERVER_PORT}/public/images/site/profile_picture.jpg`,
          profile_background_link: `${process.env.SERVER_PROTOCOL}://${process.env.IP_DOMAIN}:${process.env.SERVER_PORT}/public/images/site/profile_background.jpg`,
          projects_background_link: `${process.env.SERVER_PROTOCOL}://${process.env.IP_DOMAIN}:${process.env.SERVER_PORT}/public/images/site/projects_background.jpg`,
          articles_background_link: `${process.env.SERVER_PROTOCOL}://${process.env.IP_DOMAIN}:${process.env.SERVER_PORT}/public/images/site/articles_background.jpg`,
          hobbies_background_link: `${process.env.SERVER_PROTOCOL}://${process.env.IP_DOMAIN}:${process.env.SERVER_PORT}/public/images/site/hobbies_background.jpg`,
          cv_link: `${process.env.SERVER_PROTOCOL}://${process.env.IP_DOMAIN}:${process.env.SERVER_PORT}/public/documents/CV.pdf`,
          created_at: new Date(),
          updated_at: new Date()
        },
      ]
