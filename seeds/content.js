        ...
        [
          {
            ...
            media_link: `${environment.SERVER_URL}/public/images/movie_predictor.jpg`,
          ...
          },
          {
            ...
            media_link: `${environment.SERVER_URL}/public/images/diagram_optimiser.png`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            media_link: `${environment.SERVER_URL}/public/images/web_library.jpg`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            media_link: `${environment.SERVER_URL}/public/images/terraform_visualiser.jpg`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          },
          {
            ...
            media_link: `${environment.SERVER_URL}/public/images/shared_whiteboard.jpg`,
            media_type: types.IMAGE_MEDIA_TYPE,
            content_type: types.PROJECT_CONTENT_TYPE,
            created_at: new Date(),
            updated_at: new Date()
          ...
          },
          {
            ...
            text: '',
            link: '',
            media_link: `${environment.SERVER_URL}/public/documents/decision_trees.pdf`,
