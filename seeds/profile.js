      ...
      return knex('profile').insert([
        {
          ...
          profile_picture_link: 'http://stevenberrisford.com/public/images/profile_picture.jpg',
          background_image_link: 'http://stevenberrisford.com/public/images/background_image.jpg',
          cv_link: 'http://stevenberrisford.com/public/documents/cv.pdf',
          created_at: new Date(),
          updated_at: new Date()
        },
      ]
